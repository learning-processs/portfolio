...
const Project = () => {
  return (
    ...
    <motion.h1 initial={{ y:100}} transition={{delay:0.2 ,duration:1}} whileInView={{y:0}} viewport={{once:true}}
     className="text-4xl font-semibold py-4">Projects</motion.h1>
    <motion.hr  initial={{ y:100}} transition={{delay:0.2 ,duration:1}} whileInView={{y:0}} viewport={{once:true}}
     className="border-t-2 border-red-600 w-32 my-2 " />
