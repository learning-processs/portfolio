  ...
  return (
    <div 
     className="bg-pink-50" id="about">
      <motion.div initial={{opacity:0.2, y:100}} whileInView={{opacity:1, y:0}} transition={{duration:1}}  viewport={{once:false}}
        id="about"
        className="relative w-full max-w-4xl sm:py-80 py-40 mx-auto overflow-x-hidden 
